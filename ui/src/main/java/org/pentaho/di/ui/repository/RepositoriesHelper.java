...
public class RepositoriesHelper {
  ...
  public void loginToRepository() throws KettleException, KettleSecurityException {
    if ( model != null && model.getSelectedRepository() != null ) {
      System.out.println("loginToRepository(): model.getRepositoryIndex( model.getSelectedRepository())");
      RepositoryMeta repositoryMeta =
        input.getRepository( model.getRepositoryIndex( model.getSelectedRepository() ) );
      System.out.println("loginToRepository(): PluginRegistry.getInstance().loadClass(RepositoryPluginType.class, repositoryMeta.getId(), Repository.class );");
      repository =
        PluginRegistry.getInstance().loadClass(
          RepositoryPluginType.class, repositoryMeta.getId(), Repository.class );
      System.out.println("loginToRepository(): repository.init( repositoryMeta );");
      repository.init( repositoryMeta );
      System.out.println("loginToRepository(): repository.connect( model.getUsername(), model.getPassword() );");
